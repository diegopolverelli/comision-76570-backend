...
let heroesArchivo=JSON.parse(fs.readFileSync(rutaArchivo, "utf-8"))
console.log(heroesArchivo)
console.log(heroesArchivo[0].name)
console.log(heroesArchivo[3].name)
